        ...
        <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    @if (Route::has('login'))
                        @auth
                            <a href="{{ url('/dashboard') }}" class="hidden sm:inline-block px-6 py-2.5 rounded-md text-sm font-medium text-white bg-red-600 hover:bg-red-700 transition-colors">Dashboard</a>
                        @else
            ...
            <div class="w-full sm:max-w-md mt-6 px-6 py-8 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
                <div class="text-center mb-8">
                    <a href="/" wire:navigate>
                        <svg class="h-12 w-auto mx-auto" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="32" height="32" rx="8" fill="#DC2626"/><text x="8" y="23" font-family="Inter, sans-serif" font-weight="bold" font-size="18" fill="white">B</text></svg>
                    </a>
                </div>
        ...
        <div class="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
            <div class="pb-8 xl:grid xl:grid-cols-5 xl:gap-8">
                <div class="space-y-8 xl:col-span-2">
                    ...
                    <p class="text-gray-300 text-base max-w-xs">
                        The largest job portal for garments & textiles sector in Bangladesh.
                    </p>
                </div>
                    ...
                    <div class="md:grid md:grid-cols-3 md:gap-8 col-span-2">
                        <div>
                            ...
                            <ul class="mt-4 space-y-4">
                                ...
                                <li><a href="#" class="text-base text-gray-300 hover:text-white">Services</a></li>
                                <li><a href="#" class="text-base text-gray-300 hover:text-white">Community</a></li>
                                <li><a href="#" class="text-base text-gray-300 hover:text-white">Testimonial</a></li>
                            </ul>
                        </div>
                        <div class="mt-12 md:mt-0">
                            <h3 class="text-sm font-semibold text-gray-200 tracking-wider uppercase">Developers</h3>
                            <ul class="mt-4 space-y-4">
                                <li><a href="#" class="text-base text-gray-300 hover:text-white">Web Technologies</a></li>
                                <li><a href="#" class="text-base text-gray-300 hover:text-white">Learn Web Development</a></li>
                                <li><a href="#" class="text-base text-gray-300 hover:text-white">MM Plus</a></li>
                                <li><a href="#" class="text-base text-gray-300 hover:text-white">Hacks Blog</a></li>
                            </ul>
                        </div>
                        <div class="mt-12 md:mt-0">
                            <h3 class="text-sm font-semibold text-gray-200 tracking-wider uppercase">Our communities</h3>
                            <ul class="mt-4 space-y-4">
                                <li><a href="#" class="text-base text-gray-300 hover:text-white">MM Communities</a></li>
                                <li><a href="#" class="text-base text-gray-300 hover:text-white">MM Forum</a></li>
                                <li><a href="#" class="text-base text-gray-300 hover:text-white">MM Chat</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="mt-12 md:mt-0">
                        <h3 class="text-sm font-semibold text-gray-200 tracking-wider uppercase">Contact</h3>
                        <ul class="mt-4 space-y-4">
                            <li class="flex items-center"><svg class="flex-shrink-0 h-5 w-5 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg><span class="ml-3 text-base text-gray-300">+123 456 7890</span></li>
                            <li class="flex items-center"><svg class="flex-shrink-0 h-5 w-5 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg><span class="ml-3 text-base text-gray-300">support@mm.com</span></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
                ...
                <p class="mt-8 text-base text-gray-400 md:mt-0 md:order-1">&copy; {{ date('Y') }} BGEA Jobs. Develop by POPCORN IT.</p>
            </div>
        </div>
    </footer>
