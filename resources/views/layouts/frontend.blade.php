        ...
        <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="#" class="text-sm font-medium text-gray-700 hover:text-red-600">Build Your CV</a>
                </div>
                <div class="flex items-center space-x-4">
                    <a href="#" class="hidden sm:inline-block px-6 py-2.5 rounded-md text-sm font-medium text-white bg-red-600 hover:bg-red-700 transition-colors">Sign In</a>
                    <button class="md:hidden p-2 rounded-md text-gray-500 hover:text-gray-700">
